export const SignPlusIcon = () => {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle opacity="0.2" cx="12" cy="12" r="12" fill="#474975"/>
            <path d="M11.5 6V17" stroke="#474975" strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M6 11.5L17 11.5" stroke="#474975" strokeWidth="2.3" strokeLinecap="round"
    ...
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke="#002056" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    ...
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke="#474975" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M22 22L20 20" stroke="#474975" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    ...
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke="#474975" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round"
                strokeLinejoin="round"/>
            <path d="M11.89 5.05005C12.32 7.81005 14.56 9.92005 17.34 10.2" stroke="#474975" strokeWidth="1.5"
                  strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M3 22H21" stroke="#474975" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round"
                  strokeLinejoin="round"/>
        </svg>
...
export const UserIcon = () => {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M20.5899 22C20.5899 18.13 16.7399 15 11.9999 15C7.25991 15 3.40991 18.13 3.40991 22" stroke="#fff"
    ...
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke="#474975" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
